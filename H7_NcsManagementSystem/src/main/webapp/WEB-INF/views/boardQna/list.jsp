		...
		<c:forEach items="${blist}" var="dto">
			<tr>
				<td style="width: 10px">${dto.bid }</td>
						<td>
				<a href="/controller/boardQna/read${pageMaker.makeSearch()}&bid=${dto.bid}">
				<c:forEach var="indento" begin="1" end="${dto.bindent}" step="1">&ensp;</c:forEach>
				<c:if test="${dto.bindent ne 0}">└</c:if>
				${dto.btitle }</a></td>
